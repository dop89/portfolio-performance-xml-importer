...
enum class AccountTransactionType {
    BUY, DEPOSIT, DIVIDENDS, DELIVERY_INBOUND, DELIVERY_OUTBOUND, FEES, FEES_REFUND, INTEREST, INTEREST_CHARGE, REMOVAL, SELL, TAXES, TAX_REFUND, TRANSFER_IN, TRANSFER_OUT
}
